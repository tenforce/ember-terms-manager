...
`import layout from 'terms-manager/templates/components/visual-gender-box'`

VisualGenderBoxComponent = Ember.Component.extend
  layout: layout
  tagName: ''

  empty: Ember.computed 'emptyMale', 'emptyFemale', 'emptyNeutral', ->
    @get('emptyMale') and @get('emptyFemale') and @get('emptyNeutral')
